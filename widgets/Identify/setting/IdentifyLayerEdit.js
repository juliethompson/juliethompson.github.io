  ...
  function(
    ...
    return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
      ...
      postCreate: function() {
        ...
        this.displayFieldsTable = new iSimpleTable({
          _rowHeight:40,
          autoHeight:false,
          maxHeight:'127px',
          selectable:true,
          fields:[
            {name:'name',title:this.nls.name,type:'text',editable:false,unique:true,hidden:true},
            {name:'alias',title:this.nls.name,type:'text',editable:false},
            {name:'useralias',title:this.nls.alias,type:'text',editable:true},
        ...
        html.addClass(this.displayFieldsTable.domNode, "identifyLayerFieldsTable");
